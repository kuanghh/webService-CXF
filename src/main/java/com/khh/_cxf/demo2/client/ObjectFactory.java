 ...
 * generated in the com.khh._cxf.demo2.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.demo2._cxf.khh.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.demo2._cxf.khh.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.khh._cxf.demo2.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.demo2._cxf.khh.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.demo2._cxf.khh.com/", name = "queryWeatherResponse")
