 ...
 * generated in the com.khh._webservice.demo1.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://demo1._webservice.khh.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://demo1._webservice.khh.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.khh._webservice.demo1.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo1._webservice.khh.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo1._webservice.khh.com/", name = "queryWeather")
